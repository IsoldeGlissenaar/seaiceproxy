...
# Date: 14/02/2022
# Name: predict_sit_1992-2020.py
# Description: Trains Random Forest Regression model on training dataset and predicts sea ice thickness
#              for 1992-2020 in the Canadian Arctic.
# Input requirements: Training dataset_X and dataset_y, 1992-2020 dataset for both C-band and Ku-band
# Output: Predicted sea ice thickness for 1992-2020
"""
...
data = xr.Dataset(
    ...
    attrs=dict(description="Predicted sea ice thickness from RandomForestRegression Model (1993-2020)"))
    
direc = '../../data/proxy_SIT/'
data.to_netcdf(direc+'predic_sit_19932020_'+month+'.nc')
