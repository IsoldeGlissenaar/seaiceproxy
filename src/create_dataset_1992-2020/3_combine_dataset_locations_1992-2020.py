...
for i in range(len(locations)):
    ...
    dataset_X = pd.read_csv('../../data/interim/datasetsML/no_CS2/'+locations[i]+'/incl_'+scat+'/dataset_x_1992-2019_'+month+'.csv') 
    dataset_y = pd.read_csv('../../data/interim/datasetsML/no_CS2/'+locations[i]+'/incl_'+scat+'/dataset_y_1992-2019_'+month+'.csv')
...
dataset_X_tot.to_csv('../../data/interim/datasetsML/no_CS2/all_locations/incl_'+scat+'/dataset_x_1992-2019_'+month+'.csv',
                    index=False)
dataset_y_tot.to_csv('../../data/interim/datasetsML/no_CS2/all_locations/incl_'+scat+'/dataset_y_1992-2019_'+month+'.csv',
                    index=False)
