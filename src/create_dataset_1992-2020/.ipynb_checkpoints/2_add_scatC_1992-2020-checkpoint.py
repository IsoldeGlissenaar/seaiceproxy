...
# Import dataset
dataset_X = pd.read_csv('../../data/dataset/'+location+'_dataset_x_1992-2019_'+str("{:02d}".format(m))+'_noCS2.csv')
dataset_y = pd.read_csv('../../data/dataset/'+location+'_dataset_y_1992-2019_'+str("{:02d}".format(m))+'_noCS2.csv')
...
for i in range(len(years_e1)):
    for j in range(len(days)):
        ...
        esfile = xr.open_dataset(direc+'/Scatterometer/ERS1/monthly/ers1_monthly_'+str(yr)+'_'+str("{:02d}".format(m))+'.nc')
...
for i in range(len(years_e2)):
    for j in range(len(days)):
        ...
        try:
            ...
            sir_fname = direc+'/Scatterometer/ERS2/grd/'+f
            ...
            try:
                ...
                try:
                    ...
                    sir_fname = '/Scatterometer/ERS2/grd/'+f
                    image, head, descrip, iaopt = loadsir(sir_fname)                
...
dataset_X.to_csv('../../data/dataset/C-band/'+location+'_dataset_x_1992-2019_'+str("{:02d}".format(m))+'.csv',
                    index=False)
dataset_y.to_csv('../../data/dataset/C-band/'+location+'_dataset_y_1992-2019_'+str("{:02d}".format(m))+'.csv',
                    index=False)
