...
#%%
dataset_X = pd.read_csv('../../data/dataset/'+scat+'-band/dataset_x_1992-2019_'+month+'.csv')
dataset_y = pd.read_csv('../../data/dataset/'+scat+'-band/dataset_y_1992-2019_'+month+'.csv')

dataset_X_train = pd.read_csv('../../data/training_dataset/'+scat+'-band/dataset_x_2011-2019_'+month+'.csv')
dataset_y_train = pd.read_csv('../../data/training_dataset/'+scat+'-band/dataset_y_2011-2019_'+month+'.csv')
...
#%%
dataset_X.to_csv('../../data/dataset/'+scat+'-band/dataset_x_1992-2019_'+month+'.csv',
                    index=False)
dataset_y.to_csv('../../data/dataset/'+scat+'-band/dataset_y_1992-2019_'+month+'.csv',
                    index=False)

dataset_X_train.to_csv('../../data/training_dataset/'+scat+'-band/dataset_x_2011-2019_'+month+'.csv',
                       index=False)
dataset_y_train.to_csv('../../data/training_dataset/'+scat+'-band/dataset_y_2011-2019_'+month+'.csv',
                       index=False)
