...
def main():
    ...
    dataset_X.to_csv('../../../data/interim/datasetsML/no_CS2/'+location+'/raw/'+location+'_dataset_x_1992-2019_'+m+'_noCS2.csv',
                        index=False)
    dataset_y.to_csv('../../../data/interim/datasetsML/no_CS2/'+location+'/raw/'+location+'_dataset_y_1992-2019_'+m+'_noCS2.csv',
                        index=False)
