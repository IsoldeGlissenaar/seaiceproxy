...
def CS2_coordinates():
    ...
    cs = xr.open_dataset(direc+'/CryoSat-2 Sea Ice Thickness Grids/ubristol_cryosat2_seaicethickness_nh25km_2011_04_v1.nc')
...
def main():
    ...
    dataset_X.to_csv('../../data/training_dataset/'+location+'_dataset_x_2011-2019_'+m+'.csv',
                        index=False)
    dataset_y.to_csv('../../data/training_dataset/'+location+'_dataset_y_2011-2019_'+m+'.csv',
                        index=False)
