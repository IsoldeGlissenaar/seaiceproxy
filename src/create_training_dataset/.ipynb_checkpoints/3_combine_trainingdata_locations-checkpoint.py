...
for i in range(len(locations)):
    ...
    dataset_X = pd.read_csv('../../data/training_dataset/'+scat+'-band/'+location+'_dataset_x_2011-2019_'+month+'.csv') 
    dataset_y = pd.read_csv('../../data/training_dataset/'+scat+'-band/'+location+'_dataset_y_2011-2019_'+month+'.csv')
...
dataset_X_tot.to_csv('../../data/training_dataset/'+scat+'-band/dataset_x_2011-2019_'+month+'.csv',
                    index=False)
dataset_y_tot.to_csv('../../data/training_dataset/'+scat+'-band/dataset_y_2011-2019_'+month+'.csv',
                    index=False)
