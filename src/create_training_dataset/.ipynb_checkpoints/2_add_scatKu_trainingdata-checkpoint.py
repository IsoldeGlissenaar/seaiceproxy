...
dataset_X.to_csv('../../data/training_dataset/Ku-band/'+location+'_dataset_x_2011-2019_'+str("{:02d}".format(m))+'.csv',
                    index=False)
dataset_y.to_csv('../../data/training_dataset/Ku-band/'+location+'_dataset_y_2011-2019_'+str("{:02d}".format(m))+'.csv',
                    index=False)
