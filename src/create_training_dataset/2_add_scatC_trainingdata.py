...
ers_fname = 'C:/Users/zq19140/OneDrive - University of Bristol/Documents/SatelliteData/Scatterometer/ERS2/grd/ers2-a-Arc00-001-006.grd'
...
dataset_X.to_csv('../../../data/interim/datasetsML/monthly/'+location+'/incl_C/dataset_x_2011-2019_'+str("{:02d}".format(m))+'.csv',
                    index=False)
dataset_y.to_csv('../../../data/interim/datasetsML/monthly/'+location+'/incl_C/dataset_y_2011-2019_'+str("{:02d}".format(m))+'.csv',
                    index=False)
